...
execute @s[tag=isAfk,scores={afkBackground=1}] ~~~ tellraw @a {"rawtext":[{"text":"§d"},{"selector":"@s"},{"text":" §cwas kicked for being AFK!"}]}
...
execute @s[scores={afkKick=1}] ~~~ kick @s §cYou were kicked for being AFK! Don't go AFK!
execute @s[tag=isAfk,scores={afkBackground=2}] ~~~ tellraw @a {"rawtext":[{"text":"§d"},{"selector":"@s"},{"text":" §cis now AFK!"}]}
